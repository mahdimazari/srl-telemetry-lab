...
import { SortOrder, TimeZone as TimeZone$1, TimeZoneBrowser as TimeZoneBrowser$1, TimeZoneUtc as TimeZoneUtc$1, DataQuery as DataQuery$1, MatcherConfig, DataSourceRef as DataSourceRef$1, DataTransformerConfig, AnnotationQuery as AnnotationQuery$1, DataSourceJsonData as DataSourceJsonData$1, DataTopic, MapLayerOptions, ComparisonOperation } from '@grafana/schema';
 ...
 */
declare abstract class FunctionalVector<T = any> implements Vector<T> {
...
type PluginExtensionComponent = PluginExtensionBase & {
...
type PluginExtensionComponentConfig<Context extends object = object> = {
    type: PluginExtensionTypes.component;
    title: string;
    description: string;
    component: React$1.ComponentType<{
...
declare class AppPlugin<T extends KeyValue = KeyValue> extends GrafanaPlugin<AppPluginMeta<T>> {
    ...
    configureExtensionComponent<Context extends object>(extension: Omit<PluginExtensionComponentConfig<Context>, 'type'>): this;
}
/**
 ...
 */
interface DataSourceGetTagValuesOptions {
    key: string;
    /**
     * The other existing filters or base filters. New in v10.3
     */
 ...
 */
type ExploreQueryFieldProps<DSType extends DataSourceApi<TQuery, TOptions>, TQuery extends DataQuery = DataQuery, TOptions extends DataSourceJsonData = DataSourceJsonData> = QueryEditorProps<DSType, TQuery, TOptions>;
...
interface Vector<T = any> extends Array<T> {
    length: number;
    /**
 ...
 * @deprecated
 */
declare function makeArrayIndexableVector<T extends Vector>(v: T): T;
...
interface DataSourceWithSupplementaryQueriesSupport<TQuery extends DataQuery$1> {
     ...
     */
    getSupplementaryRequest?(type: SupplementaryQueryType, request: DataQueryRequest<TQuery>): DataQueryRequest<TQuery> | undefined;
    /**
...
declare const hasSupplementaryQuerySupport: <TQuery extends DataQuery$1>(datasource: DataSourceApi<DataQuery, DataSourceJsonData, {}> | (DataSourceApi<DataQuery, DataSourceJsonData, {}> & DataSourceWithSupplementaryQueriesSupport<TQuery>), type: SupplementaryQueryType) => datasource is DataSourceApi<DataQuery, DataSourceJsonData, {}> & DataSourceWithSupplementaryQueriesSupport<TQuery>;
 ...
 */
declare class AppendedVectors<T = any> extends FunctionalVector<T> {
    length: number;
 ...
 * @deprecated use a simple Array<T>
 */
declare class ArrayVector<T = any> extends Array<T> {
    get buffer(): any[];
 ...
 */
declare class ConstantVector<T = any> extends Array<T> {
 ...
 * @deprecated use a simple Arrays.  NOTE: Not used in grafana core
 */
declare class BinaryOperationVector extends Array<number> {
 ...
 * @deprecated use a simple Arrays
 */
declare class SortedVector<T = any> extends FunctionalVector<T> {
    private source;
    private order;
 ...
 * @deprecated use a simple Arrays. NOTE: not used in grafana core.
 */
declare class FormattedVector<T = any> extends Array<string> {
 ...
 * @deprecated use a simple Arrays.  NOTE: not used in grafana core
 */
declare class IndexVector extends Array<number> {
 ...
 * @deprecated use a simple Arrays.  NOTE: Not used in grafana core
 */
declare class AsNumberVector extends Array<number> {
 ...
 * @public
 */
declare function arrayToDataFrame(source: any[], names?: string[]): DataFrame;
...
declare class StreamingDataFrame implements DataFrame {
    ...
    private constructor();
    serialize: (fieldPredicate?: ((f: Field) => boolean) | undefined, optionsOverride?: Partial<StreamingFrameOptions>, trimValues?: {
        maxLength?: number;
